...
//Outputs the value in the variable-name in console.
console.log(name);

// Outputs the string "<br/>"  in the console.
console.log("<br/>");
...
//Outputs the value assigned in the console, in  this instance  the output will be, "ozzy emma otim".
console.log(name);
...
//Outputs the value assigned in the console, in  this instance  the output will be, "marrie jacob ozyy"
console.log(name);
...
//Outputs the value assigned in the console, in  this instance  the output will be, " ozyy diane" .
console.log(name);
...
//Outputs the value assigned in the console, in  this instance  the output will be, "joanita paul ozzy"
console.log(name);
...
//Outputs the value of x in the console, in this instance it will be a string "undefined"
console.log(x);
